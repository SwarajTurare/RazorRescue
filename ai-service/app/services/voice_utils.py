...
SARVAM_LANG_MAP = {
    ...
    "Bengali": "bn-IN", "Kannada": "kn-IN", "Gujarati": "gu-IN",
    "Punjabi": "pa-IN", "Telugu": "te-IN", "English": "en-IN", "Hinglish": "hi-IN"
}

SARVAM_SPEAKER_MAP = {
    "hi-IN": "shubh", "mr-IN": "shubh", "ta-IN": "priya",
    "te-IN": "priya", "kn-IN": "kavya", "bn-IN": "ritu",
    "gu-IN": "shubh", "pa-IN": "shubh", "en-IN": "ritu"
}
